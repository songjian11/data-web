...
@Data
@ApiModel(value = "FreshDailyReportResponse", description = "生鲜战区报表")
public class FreshDailyReportResponse implements Serializable {
    ...
    @ApiModelProperty(value = "是否下钻(0-否，1-是)", required = true)
