 ...
 */
@Repository
public class StoreGMBattleDao extends AbstractDao {
	private static final RowMapper<BaseReport> BASE_REPORT_RM = new BeanPropertyRowMapper<>(BaseReport.class);
	// 当日实时总毛利列表
	private static final String GET_TODAY_GM_LIST = "select sale.SALE_HOUR AS time,company.com_id as org_id,company.com_name  as org_name, "
			+ "NVL(sum((sale.GP_ECL+SALE.AMT_ECL*NVL(income.IN_VALUES,0)-SALE.AMT_ECL*NVL(income.DC_VALUES,0))),0) AS value  "
			...
			+ "and sale.store_id=? group by sale.SALE_HOUR,company.com_id,company.com_name";
	// 当日实时前台毛利列表
	private static final String GET_TODAY_FGM_LIST = "select sale.SALE_HOUR AS time,sale.COM_ID as org_id,company.COM_NAME as org_name,"
			+ "sale.GP_ECL AS value from CSMB_COM_SALES sale "
	...
	private static final String GET_CURMONTH_GM_LIST = "select time,org_id,NVL(sum(value),0) AS value,org_name "
			+ "from (select to_char(history.SALE_DATE,'yyyy-mm-dd') AS time,company.COM_ID as org_id, "
			...
			+ "and history.store_id=?) group by time,org_id,org_name";
	...
	private static final String GET_LASTYEAR_DAY_LIST = "SELECT  /*+PARALLEL(8)*/  b.com_id as org_id "
			+ ",b.com_name as org_name,sum(a.total_real_amt / (1 + a.sale_vat_rate / 100) - a.unit_cost_ecl * a.qty) as value "
	 ...
	 * @throws Exception
	 */
	public List<BaseReport> getTodayGMList(String storeId) throws Exception {
		return super.queryForList(GET_TODAY_GM_LIST, BASE_REPORT_RM, storeId, storeId);
	}
	 ...
	 * @throws Exception
	 */
	public List<BaseReport> getTodayFGMList(String storeId) throws Exception {
		return super.queryForList(GET_TODAY_FGM_LIST, BASE_REPORT_RM, storeId);
	}
	 ...
	 * @throws Exception
	 */
	public List<BaseReport> getCurMonthGMList(String storeId) throws Exception {
		return super.queryForList(GET_CURMONTH_GM_LIST, BASE_REPORT_RM, storeId, storeId);
	}
	 ...
	 * @throws Exception
	 */
	public BigDecimal getLastYearDayGMTotal(String storeId) throws Exception {
		Object[] args = { storeId };
	 ...
	 * @throws Exception
	 */
	public BigDecimal getLastMonthDayGMTotal(String storeId) throws Exception {
		Object[] args = { storeId };
	 ...
	 * @throws Exception
	 */
	public BigDecimal getLastYearMonthGMTotal(String storeId) throws Exception {
		Object[] args = { storeId };
	 ...
	 * @throws Exception
	 */
	public BigDecimal getLastMonthGMTotal(String storeId) throws Exception {
		Object[] args = { storeId };
