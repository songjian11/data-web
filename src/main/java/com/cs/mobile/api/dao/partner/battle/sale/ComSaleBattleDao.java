 ...
 */
@Repository
public class ComSaleBattleDao extends AbstractDao {
	private static final RowMapper<BaseReport> BASE_REPORT_RM = new BeanPropertyRowMapper<>(BaseReport.class);
	// 当日实时销售列表
	private static final String GET_TODAY_SALE_LIST = "select sale.SALE_HOUR AS time,sale.DEPT_ID as org_id,sale.DEPT_ID as org_name, "
			+ "sale.AMT_ECL AS value from CSMB_DEPT_SALES sale left join CSMB_COMPANY company "
	...
	// 当月历史销售列表
	private static final String GET_CURMONTH_SALE_LIST = "select to_char(history.SALE_DATE,'yyyy-mm-dd') AS time,history.SALE_VALUE AS value,company.DEPT_ID as org_id "
			+ ",company.DEPT_ID as org_name from CSMB_DEPT_SALES_HISTORY history " + "left join CSMB_COMPANY company "
	...
	// 去年本月销售总额
	private static final String GET_LASTYEARMONTH_SALE_TOTAL = "select NVL(sum(history.SALE_VALUE),0) from CSMB_DEPT_SALES_HISTORY history "
			+ "left join CSMB_COMPANY company "
			+ "on company.STORE_ID=HISTORY.STORE_ID and COMPANY.DEPT_ID=HISTORY.DEPT_ID "
	...
	// 上个月销售总额
	private static final String GET_LASTMONTH_SALE_TOTAL = "select NVL(sum(SALE_VALUE),0) from CSMB_DEPT_SALES_HISTORY history "
			+ "left join CSMB_COMPANY company "
			+ "on company.STORE_ID=HISTORY.STORE_ID and COMPANY.DEPT_ID=HISTORY.DEPT_ID "
	...
	private static final String GET_LASTYEAR_DAY_LIST = "SELECT  /*+PARALLEL(8)*/  b.dept_id as org_id "
			+ ",b.dept_id as org_name,sum(a.total_real_amt / (1 + a.sale_vat_rate / 100)) as value "
	 ...
	 * @throws Exception
	 */
	public List<BaseReport> getTodaySaleList(String storeId, String comId) throws Exception {
		return super.queryForList(GET_TODAY_SALE_LIST, BASE_REPORT_RM, comId, storeId);
	}
	 ...
	 * @throws Exception
	 */
	public List<BaseReport> getCurMonthSaleList(String storeId, String comId) throws Exception {
		return super.queryForList(GET_CURMONTH_SALE_LIST, BASE_REPORT_RM, comId, storeId);
	}
	 ...
	 * @throws Exception
	 */
	public BigDecimal getLastYearDaySaleTotal(String storeId, String comId) throws Exception {
	 ...
	 * @throws Exception
	 */
	public BigDecimal getLastMonthDaySaleTotal(String storeId, String comId) throws Exception {
		Object[] args = { comId, storeId };
	 ...
	 * @throws Exception
	 */
	public BigDecimal getLastYearMonthSaleTotal(String storeId, String comId) throws Exception {
		Object[] args = { comId, storeId };
	 ...
	 * @throws Exception
	 */
	public BigDecimal getLastMonthSaleTotal(String storeId, String comId) throws Exception {
		Object[] args = { comId, storeId };
